...
export type UserQuery = (
  ...
  & { user?: Maybe<(
    { __typename?: 'User' }
    & Pick<User, 'id' | 'username' | 'slug' | 'bio' | 'avatarUrl'>
  )> }
);
