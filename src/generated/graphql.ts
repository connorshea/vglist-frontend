...
export type GameLibraryQueryVariables = Exact<{
  id?: Maybe<Scalars['ID']>;
}>;
...
export type GameLibraryQuery = (
  ...
  & { user?: Maybe<(
    ...
    & { gamePurchases?: Maybe<(
      ...
      & { nodes?: Maybe<Array<Maybe<(
        { __typename?: 'GamePurchase' }
        & Pick<GamePurchase, 'id' | 'comments' | 'completionDate' | 'completionStatus' | 'hoursPlayed' | 'rating' | 'startDate' | 'replayCount'>
        & { platforms?: Maybe<(
          { __typename?: 'PlatformConnection' }
          & { nodes?: Maybe<Array<Maybe<(
            { __typename?: 'Platform' }
